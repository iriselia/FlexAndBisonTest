...
function(setup_solution SOLUTION_NAME)
	...
	FOREACH(curFile ${allProjects})
		...
		SET( FLEX_EXECUTABLE "${CMAKE_SOURCE_DIR}/CMake/flex_bison/flex.exe")
		SET( BISON_EXECUTABLE "${CMAKE_SOURCE_DIR}/CMake/flex_bison/bison.exe")
...
file(GLOB_RECURSE MY_PRECOMPILED_HEADER ${CMAKE_CURRENT_SOURCE_DIR}/stdafx.h)
file(GLOB_RECURSE MY_PRECOMPILED_SOURCE ${CMAKE_CURRENT_SOURCE_DIR}/stdafx.cpp)
#----- Flex and Bison -----
...
#----- FINALIZE PRECOMPILED HEADER -----
# Process Optional pre-compiled header name and source name
if( PRECOMPILED_HEADER AND PRECOMPILED_SOURCE )
	if( NOT PRECOMPILED_HEADER STREQUAL "" AND NOT PRECOMPILED_SOURCE STREQUAL "")
		set( MY_PRECOMPILED_HEADER ${PRECOMPILED_HEADER} )
		set( MY_PRECOMPILED_SOURCE ${PRECOMPILED_SOURCE} )
	endif()
endif()
...
IF(MSVC)
	...
	message("Precompiled Header Found For ${PROJECT_NAME}: ${MY_PRECOMPILED_HEADER} & ${MY_PRECOMPILED_SOURCE}" )
...
#MESSAGE("${${PROJECT_NAME}_SOURCE_DIR}/src/lexer.l")
